...
public final class MitoModel2ForModeChoiceCalibration {
    ...
    private static final Logger logger = LogManager.getLogger(MitoModel2ForModeChoiceCalibration.class);
    private final String scenarioName;

    private DataSetImpl dataSet;

    private MitoModel2ForModeChoiceCalibration(DataSetImpl dataSet, String scenarioName) {
    ...
    public static MitoModel2ForModeChoiceCalibration standAloneModel(String propertiesFile, ImplementationConfig config) {
        ...
        MitoModel2ForModeChoiceCalibration model = new MitoModel2ForModeChoiceCalibration(new DataSetImpl(), Resources.instance.getString(Properties.SCENARIO_NAME));
