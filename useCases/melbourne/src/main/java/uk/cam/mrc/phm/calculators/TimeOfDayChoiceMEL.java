...
public final class TimeOfDayChoiceMEL extends Module {

    private static final Logger logger = LogManager.getLogger(TimeOfDayChoiceMEL.class);
    ...
    public TimeOfDayChoiceMEL(DataSet dataSet, List<Purpose> purposes) {
