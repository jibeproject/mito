...
public class DefaultModeChoiceCalibrationData implements ModeChoiceCalibrationData {
    ...
    private static Logger logger = LogManager.getLogger(DefaultModeChoiceCalibrationData.class);

    public DefaultModeChoiceCalibrationData() {
