...
public class DestinationUtilityCalculatorMEL extends AbstractDestinationUtilityCalculator {
    ...
    // HBW calibrated (mean); yyyy-mm-dd:
    // private final static double[] TRAVEL_DISTANCE_PARAM_HBW = {};
    ...
    // HBE calibrated (mean); yyyy-mm-dd:
//    private final static double[] TRAVEL_DISTANCE_PARAM_HBE = {};
    ...
    // HBE calibrated (mean); yyyy-mm-dd:
//    private final static double[] TRAVEL_DISTANCE_PARAM_HBA = {};
    private final static double IMPEDANCE_PARAM_HBA =  6.03;  // vista-based calibrate;
    ...
    // HBS semi-calibrated (mean); yyyy-mm-dd:
//    private final static double[] TRAVEL_DISTANCE_PARAM_HBS = {};
    private final static double IMPEDANCE_PARAM_HBS = 5.35;  // vista-based
    ...
    // HBR calibrated (mean); yyyy-mm-dd:
//    private final static double[] TRAVEL_DISTANCE_PARAM_HBR = {};
    private final static double IMPEDANCE_PARAM_HBR = 6.48; // vista-based
    ...
    // HBO calibrated (mean); yyyy-mm-dd:
//    private final static double[] TRAVEL_DISTANCE_PARAM_HBO = {};
...
//    private final static double[] TRAVEL_DISTANCE_PARAM_NHBW = {};
    private final static double IMPEDANCE_PARAM_NHBW = 8.07; // vista-based calibrate
    ...
    // NHBO calibrated (mean);yyyy-mm-dd:
//    private final static double[] TRAVEL_DISTANCE_PARAM_NHBO = {};
    private final static double IMPEDANCE_PARAM_NHBO = 7.52; // vista-based
