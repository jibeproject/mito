...
public class ModeChoiceCalculatorRrtMEL extends AbstractModeChoiceCalculator {

    private final static Logger logger = LogManager.getLogger(ModeChoiceCalculatorRrtMEL.class);

    public ModeChoiceCalculatorRrtMEL(DataSet dataSet) {
        super();
