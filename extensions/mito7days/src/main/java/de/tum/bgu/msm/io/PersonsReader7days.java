...
public class PersonsReader7days extends AbstractCsvReader {

    private static final Logger logger = LogManager.getLogger(PersonsReader7days.class);
    ...
    public PersonsReader7days(DataSet dataSet) {
        super(dataSet);
    }
